<?php
session_start();
// Tutaj możesz dodać logikę rejestracji przez API
?>
...
<head>
    ...
    <title>Smaki Świata - Rejestracja</title>
    ...
    <style>
        ...
        body {
            ...
            background-image: 
                radial-gradient(circle at 10% 20%, rgba(248, 181, 0, 0.05) 0%, transparent 20%),
                radial-gradient(circle at 90% 80%, rgba(252, 234, 187, 0.05) 0%, transparent 20%);
        }
...
<header class="register-header">
    <a href="../index2.html" style="text-decoration: none;">
        <h1 class="register-logo">Smaki Świata</h1>
    </a>
</header>
    </header>
